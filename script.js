...
const second = 1000,
  ...
  hour = minute * 60,
  day = hour * 24;
let countDown = new Date(Date.UTC(2025, 5, 15, 7, 0, 0)).getTime(); // June 15 at 12:00 AM PDT
...
new TypeIt("#teks1", {
  strings: ["Today, I wish you the best", "May the things that make you fall also become your reasons to keep growing.", "May every step you take be made easy until you achieve what you want..", "Today is your special day, and I made all of this for you"],
  startDelay: 4000,
  speed: 75,
...
new TypeIt("#teks2", {
  strings: ["Whether you know it or not you make the world a better place", " ", "Glad you're still here", " ", "- Wish all you the best, Huy"],
  startDelay: 2000,
  speed: 75,
  waitUntilVisible: true
}).go();
